...
const ContactSection = () => {
    ...
    <div className="bg-[#F26922] rounded-full p-2 flex justify-center items-center">
        <FaGlobe className="text-white" style={{ fontSize: '20px' }} />
    </div>
...
<div className="flex items-center gap-4">
    <div className="bg-[#F26922] rounded-full p-2 flex justify-center items-center">
        <FaEnvelope className="text-white" style={{ fontSize: '20px' }} />
    </div>
    <div className="text-sm sm:text-base">
        <p className="font-bold">www.heathrowbudgetparking.co.uk</p>
    </div>
...
<div className="flex items-center gap-4">
    <div className="bg-[#F26922] rounded-full p-2 flex justify-center items-center">
        <FaPhone className="text-white" style={{ fontSize: '20px' }} />
    </div>
    <div className="text-sm sm:text-base">
        <p className="font-bold">www.heathrowbudgetparking.co.uk</p>
    </div>
