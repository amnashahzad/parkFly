...
const Footer = () => {
  return (
    <footer className="mt-8 bg-black text-white py-8 text-xs sm:text-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-10">
          ...
          <div className="flex-1 space-y-4">
            ...
            <ul className="space-y-2">
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Gatwick Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Heathrow Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Birmingham Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Manchester Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Stansted Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Luton Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Bristol Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Edinburgh Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> Glasgow Airport</li>
              <li className='flex items-center gap-2 sm:gap-3'><BsFillAirplaneFill /> London City Airport</li>
            </ul>
          </div>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex justify-center space-x-4 mt-4 sm:mt-0">
              <Image src={'/paymentcards.png'} alt='Payment Cards' width={200} height={100} />
            </div>
          </div>
          <hr className='my-4 border-gray-600' />
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <p>&copy; 2024 Copyright Heathrow Budget Parking. All Rights Reserved.</p>
            <div className="flex items-center justify-center gap-4 mt-4 sm:mt-0 text-white text-xl">
              <a href="https://www.linkedin.com/company/budgetparking/about/?viewAsMember=true" target='_blank' rel="noopener noreferrer"><FaLinkedinIn /></a>
              <a href="https://x.com/HBudgetParking" target='_blank' rel="noopener noreferrer"><FaTwitter /></a>
              <a href="https://www.instagram.com/hbudgetparking/" target='_blank' rel="noopener noreferrer"><PiInstagramLogoFill /></a>
              <a href="https://www.facebook.com/budgetparking/" target='_blank' rel="noopener noreferrer"><FaFacebookF /></a>
            </div>
          </div>
        </div>
      </div>
