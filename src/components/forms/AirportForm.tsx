        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 container bg-white rounded-3xl shadow-lg p-6 sm:p-9">
            ...
            <div className="flex flex-col sm:w-[240px]">
              ...
              <select
                name="airport"
                className="py-2 px-4 bg-white w-full rounded-lg border border-gray-300"
            ...
            {/* Date From */}
            <div className="flex flex-col sm:w-[340px] sm:ml-[-35%] z-[1] rounded-lg">
              <label className="text-gray-700 font-semibold mb-2">
                Date From
              </label>
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-2 rounded-lg border border-gray-300">
                <Form {...form}>
                  <FormField
            ...
            {/* Submit Button */}
            {/* Submit Button */}
            <div className="flex flex-col sm:flex-row justify-center items-center mt-4 sm:col-span-3 sm:ml-[1000px] md:flex md:justify-end">
              <Button
                type="submit"
                className="mt-[-30px] md:mt-[-140px] w-full sm:w-[280px] bg-orange-500 text-white py-3 px-6 rounded-lg"
              >
                Get Quote
              </Button>
            </div>
